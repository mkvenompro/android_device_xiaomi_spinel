...
VENDOR_PLATFORM_LINKS := \
    $(TARGET_OUT_VENDOR)/bin/dumpfaultd.mt6789 \
    ...
    $(TARGET_OUT_VENDOR)/lib/ov20b40_aac_front_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/ov20b40_aac_front_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/ov20b40_aac_front_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/ov20b40_aac_front_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/ov20b40_ofilm_front_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/ov20b40_ofilm_front_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/ov20b40_ofilm_front_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/ov20b40_ofilm_front_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_aac_main_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_aac_main_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_aac_main_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_aac_main_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_ofilm_main_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_ofilm_main_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_ofilm_main_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_ofilm_main_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_sunny_main_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_sunny_main_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_sunny_main_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/s5khm9_sunny_main_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_aac_depth_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_aac_depth_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_aac_depth_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_aac_depth_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_sunny_depth_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_sunny_depth_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_sunny_depth_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib/sc202v_sunny_depth_mipi_raw_tuning.so \
    ...
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_aac_front_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/ov20b40_ofilm_front_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_aac_main_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_aac_main_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_aac_main_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_aac_main_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_ofilm_main_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_ofilm_main_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_ofilm_main_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_ofilm_main_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_sunny_main_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_sunny_main_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_sunny_main_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/s5khm9_sunny_main_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_aac_depth_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_aac_depth_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_aac_depth_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_aac_depth_mipi_raw_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_sunny_depth_mipi_raw_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_sunny_depth_mipi_raw_sea_IdxMgr.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_sunny_depth_mipi_raw_sea_tuning.so \
    $(TARGET_OUT_VENDOR)/lib64/sc202v_sunny_depth_mipi_raw_tuning.so \
...
ALL_DEFAULT_INSTALLED_MODULES += $(VENDOR_PLATFORM_LINKS) $(AUDIO_SYMLINKS)
